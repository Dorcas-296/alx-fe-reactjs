function UserProfile() {
  return (
    <div className="bg-gray-100 md:p-8 max-w-sm max-w-xs mx-auto,my-20 rounded-lg shadow-lg sm:p-4 md:max-w-sm">
      <img className="rounded-full w-36 h-36 mx-auto sm:w-24 h-24, md:w-36 h-36" 
